...
const allTasks = {
  ...
  "Elite": [],
  "Master": []
}; // NOTE: This is a truncated version for brevity. The full JSON would be embedded here.
...
function generateWikiLinks(task) {
    ...
    const questRegex = /(?:Completion of|Complete the quest:|Partial completion of)\s+([a-zA-Z\s'-]+)(?:\(miniquest\))?/gi;
