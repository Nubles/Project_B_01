...
if __name__ == "__main__":
    ...
    # Correct the Medium tier count
    if len(parsed_tasks["Medium"]) > 279:
        parsed_tasks["Medium"] = parsed_tasks["Medium"][:279]

    # Correct the Elite tier count
    if len(parsed_tasks["Elite"]) > 297:
        parsed_tasks["Elite"] = parsed_tasks["Elite"][:297]

    # Correct the Master tier count
    if len(parsed_tasks["Master"]) > 35:
        parsed_tasks["Master"] = parsed_tasks["Master"][:35]
